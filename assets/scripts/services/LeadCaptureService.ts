...
export class LeadCaptureService {
    ...
    private renderForm(mode: LeadFormMode): string {
        ...
        const intro = isSubmitMode
            ? 'Hippy x Guess the Brands xin gửi tặng bạn Voucher giảm tối đa 30K vì đã trở thành 1 trong những người chơi hoàn thành xuất sắc trò chơi.<br>Xin vui lòng để lại thông tin để nhận quà:'
